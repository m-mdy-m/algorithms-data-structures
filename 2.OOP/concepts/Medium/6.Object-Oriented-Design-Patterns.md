...
- [Resource acquisition is initialization(RAII):]() Simply put, RAII is when you acquire resources in a constructor and release them in the corresponding destructor.
