...
#### Main Pattern:
- [Adapter:]() Allows the use of an existing class with an incompatible interface by creating an adapter class that translates the communication between them.
---
- [Bridge:]() //
---
- [Composite]() //
