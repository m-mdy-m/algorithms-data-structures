...
```javascript
// Elevator class representing the elevator system
class Elevator {
  constructor() {
    this.currentFloor = 1; // Current floor of the elevator
    this.isMoving = false; // Indicates whether the elevator is moving
  }

  // Method to simulate moving the elevator to a specific floor
  moveToFloor(floorNumber) {
    ...
    console.log(`Elevator is moving from floor ${this.currentFloor} to floor ${floorNumber}`);
    this.isMoving = true;

    // Simulate elevator movement (setTimeout used for demonstration purposes)
    setTimeout(() => {
      this.currentFloor = floorNumber;
      this.isMoving = false;
      console.log(`Elevator has arrived at floor ${this.currentFloor}`);
    }, Math.abs(floorNumber - this.currentFloor) * 1000); // Simulate travel time
  }
...
// Example of using process abstraction
function takeElevator(floorNumber) {
  if (elevator.isMoving) {
    console.log('Wait until the elevator stops moving.');
    return;
  }
  ...
  // Additional logic (e.g., allow time for people to enter/exit the elevator)
  // ...
...
// Example usage
takeElevator(5); // Output: Elevator is moving from floor 1 to floor 5
                //         (After some time) Elevator has arrived at floor 5
                //         Elevator door is opening...
                //         (After some time) Elevator door is open.
                //         Elevator door is closing...
                //         (After some time) Elevator door is closed.
