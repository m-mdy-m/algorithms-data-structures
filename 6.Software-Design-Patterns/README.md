...
- [Object Pool:](https://github.com/m-mdy-m/algorithms-data-structures/blob/main/2.OOP/design_pattern-type/Creational/Object%20Pool.md) Object pool pattern is a software creational design pattern which is used in situations where the cost of initializing a class instance is very high. 
...
#### Main Pattern:
- [Adapter:](https://github.com/m-mdy-m/algorithms-data-structures/blob/main/2.OOP/design_pattern-type/Structural/Adapter.md) Allows the use of an existing class with an incompatible interface by creating an adapter class that translates the communication between them.
---
- [Bridge:](https://github.com/m-mdy-m/algorithms-data-structures/blob/main/2.OOP/design_pattern-type/Structural/Bridge.md) The Bridge design pattern allows you to separate the abstraction from the implementation. It is a structural design pattern. 
---
- [Composite](https://github.com/m-mdy-m/algorithms-data-structures/blob/main/2.OOP/design_pattern-type/Structural/Composite.md) The Composite Design Pattern lets you group objects into tree structures.  This allows you to treat individual objects and entire groups the same way.
---
- [Decorator](https://github.com/m-mdy-m/algorithms-data-structures/blob/main/2.OOP/design_pattern-type/Structural/Decorator.md) Decorator is a structural design pattern that lets you attach new behaviors to objects by placing these objects inside special wrapper objects that contain the behaviors.
---
- [Facade](https://github.com/m-mdy-m/algorithms-data-structures/blob/main/2.OOP/design_pattern-type/Structural/Facade.md) The facade pattern, in object-oriented programming, acts like a building's facade in architecture. It presents a simplified front-end, masking the intricate inner workings. In software terms, it's a class that provides a **streamlined interface** to a complex subsystem or library.
---
- [Flyweight](https://github.com/m-mdy-m/algorithms-data-structures/blob/main/2.OOP/design_pattern-type/Structural/Flyweight.md) The Flyweight Design Pattern offers a memory-efficient approach for creating large numbers of similar objects. It achieves this by sharing common elements among objects, reducing overall memory usage and potentially improving performance.
---
- [Proxy](https://github.com/m-mdy-m/algorithms-data-structures/blob/main/2.OOP/design_pattern-type/Structural/Proxy.md) Proxy is a structural design pattern that lets you provide a substitute or placeholder for another object. A proxy controls access to the original object, allowing you to perform something either before or after the request gets through to the original object.
---
